...
> **Подробно описано в CHECKPOINT_STRATEGY.md**

### Основное правило:

```markdown
Research → Implementation → CHECKPOINT → User проверяет → Продолжаем/Debug
```

### Делай CHECKPOINT когда:
- Завершил логическую единицу работы
- Нужно проверить гипотезу
- Сделал критические изменения
...
**См. CHECKPOINT_STRATEGY.md для деталей**
