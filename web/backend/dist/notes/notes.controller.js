...
const update_date_dto_1 = require("./dto/update-date.dto");
let NotesController = class NotesController {
    ...
    async updateDate(noteId, updateDateDto) {
...
__decorate([
    (0, common_1.Patch)(':id/date'),
    (0, swagger_1.ApiOperation)({ summary: 'Update note date and time' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Date updated successfully' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_date_dto_1.UpdateDateDto]),
    __metadata("design:returntype", Promise)
], NotesController.prototype, "updateDate", null);
__decorate([
